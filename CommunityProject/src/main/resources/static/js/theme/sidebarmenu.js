...
if (at === "vertical") {
  ...
  if (currentNewURL.includes("/main/main.html")) {
    current_link.setAttribute("href", "../main/main.html");
  } else if (currentNewURL.includes("/main.html")) {
    current_link.setAttribute("href", "./main.html");
  } else {
