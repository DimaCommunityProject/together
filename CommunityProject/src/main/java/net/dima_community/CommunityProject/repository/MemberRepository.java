...
public interface MemberRepository extends JpaRepository<MemberEntity, String> {
    ...
    //사용자 존재 확인
//    @Query("SELECT COALESCE(m.memberId, '0') FROM MemberEntity m WHERE m.memberName = :memberName AND m.memberEmail = :memberEmail AND m.memberId = :memberId")
//    String findIdByMemberNameAndMemberEmailAndMemberId(@Param("memberName") String memberName, @Param("memberEmail") String memberEmail, @Param("memberId") String memberId);
